...
import { EditExportForm } from './edit-export-form'

export default async function EditExportPage({ params }: { params: Promise<{ sessionId: string }> }) {
  ...
  return (
    <div className="p-6 space-y-5 max-w-4xl">
      <div className="flex items-center gap-3">
        <Link href={`/exports/${sessionId}`} className="text-gray-400 hover:text-gray-600 transition-colors">
          <ArrowLeft size={20} />
        </Link>
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Sửa phiếu xuất</h1>
